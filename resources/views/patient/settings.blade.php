      ...
      <div class="modal fade" id="editProfileModal" tabindex="-1" aria-labelledby="editProfileModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{route('patient.edit-profile')}}" method="post" enctype="multipart/form-data">
                @csrf
...
<script>
  $(document).ready(function() {
      $('#changePasswordForm').on('submit', function(event) {
          ...
          $.ajax({
              url: '{{ route('patient.change-password') }}', // Your route for changing password
              type: 'POST',
...
<script>
  $(document).ready(function() {
      $('#confirmDeleteButton').on('click', function() {
          $.ajax({
              url: '{{ route('patient.delete-account') }}', // Your route for deleting the account
              type: 'POST',
              data: {
