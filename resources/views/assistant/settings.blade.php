          ...
          <div class="modal-body">
              <form id="changePasswordForm">
                  ...
                  <div class="alert alert-danger d-none" id="errorList">
                      <ul class="mb-0" id="errorListItems"></ul>
                  </div>
      ...
      <div class="modal fade" id="editProfileModal" tabindex="-1" aria-labelledby="editProfileModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{route('assistant.edit-profile')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group text-center">
                  ...
                  <div class="mb-3">
                    <img src="{{ $user->getProfilePicture() }}" alt="Profile Picture" 
                         class="img-circle" style="width: 100px; height: 100px; object-fit: cover; border: 2px solid #ddd;">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" id="date" name="dob" value="{{$user->dob->format('Y-m-d')}}" required>
                </div>
                <div class="form-group">
...
<script>
  $(document).ready(function() {
      $('#changePasswordForm').on('submit', function(event) {
          ...
          $.ajax({
              url: '{{ route('assistant.change-password') }}', // Your route for changing password
              type: 'POST',
              ...
              error: function(xhr) {
                  ...
                  if (xhr.responseJSON && xhr.responseJSON.errors) {
                      ...
                      $.each(errors, function(key, value) {
                          $('#errorListItems').append('<li>' + value[0] + '</li>');
                      });
...
<script>
  $(document).ready(function() {
      $('#confirmDeleteButton').on('click', function() {
          $.ajax({
              url: '{{ route('assistant.delete-account') }}', // Your route for deleting the account
              type: 'POST',
              data: {
