...
Route::post('/patient/appointment/direct-booking', [PatientController::class, 'directBooking'])->name('patient.direct-booking');
...
Route::post('/assistant/add-session/cancel', [AssistantController::class, 'cancelSession'])->name('assistant.cancel-session');
...
Route::put('/assistant/services/{id}', [AssistantController::class, 'updateService'])->name('assistant.update-service');
Route::delete('/assistant/services/{id}', [AssistantController::class, 'deleteService'])->name('assistant.delete-service');
